...
core.provider('errorHandlerService', function () {
    ...
    return {
        ...
        $get: ["$log", "$injector", "feedbackUI", "errorHandlerConfig", "httpErrors", function ($log, $injector, feedbackUI, errorHandlerConfig, httpErrors) {
...
ui.factory('feedbackUI', ["errorHandlerConfig", "$timeout", "$rootScope", function (errorHandlerConfig, $timeout, $rootScope) {
        'use strict';
...
ui.directive('uiErrorHandler', ["$rootScope", "errorHandlerConfig", function ($rootScope, errorHandlerConfig) {
    'use strict';
